...
kubectl create secret docker-registry docker-secret --docker-server=https://index.docker.io/v2/ --docker-username=abcl0653 --docker-password=xb@abcl0653 --docker-email=fd.cailin@gmail.com
